...
import { Balance, CreationParams, DelayTimestamp, EntryParams, GigInput, OrderInput, OrderPriceParams, PackageInput, RetributionParams, UserInput } from './types';
...
const ORDER_CREATION_PARAMS: OrderPriceParams = {
	trialFlat: ONE_USD,
	trialPercent: ONE_PERCENTAGE,
	proceedFlat: ONE_USD,
	proceedPercent: ONE_PERCENTAGE
}

const SELLER_ORDER_FEES_PARAMS: OrderPriceParams = {
	trialFlat: ONE_USD,
	trialPercent: ONE_PERCENTAGE,
	proceedFlat: ONE_USD,
	proceedPercent: ONE_PERCENTAGE
...
const GIG_TEST0: GigInput = ["user0", [PACKAGE_TEST0, EMPTY_PACKAGE, EMPTY_PACKAGE]]
const GIG_TEST1: GigInput = ["user1", [PACKAGE_TEST0, PACKAGE_TEST1, EMPTY_PACKAGE]]
const GIG_TEST2: GigInput = ["user2", [PACKAGE_TEST0, PACKAGE_TEST1, PACKAGE_TEST2]]
