...
import { ADDRESS_PROVIDER_ID, USER_IMPL_ID, XP_ID } from '../../../helpers/deploy_ids';
...
import { setupBuyerAdminRoles, setupSellerAdminRoles, setupXPKeys } from '../../../helpers/init_helpers';
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
	await makeDeployment(func.id, async () => {
		...
		deployments.log(`[Deployments] XP is registered to ${ XPArtifact.address }`)
