...
export declare namespace InputTypes {
  export type CalcInvitersRewardsInputStruct = {
  ...
  export type CalcInvitersRewardsInputStructOutput = [
    BigNumber,
    BigNumber,
    BigNumber
  ] & {
...
export declare namespace OutputTypes {
  export type CalcInvitersRewardsOutputStruct = {
  ...
  export type CalcInvitersRewardsOutputStructOutput = [
    BigNumber,
    BigNumber,
    BigNumber
  ] & {
...
export interface InviterLogicInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "calcInviterRewards" | "calcInvitersRewards"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "calcInviterRewards",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "calcInvitersRewards",
    values: [InputTypes.CalcInvitersRewardsInputStruct]
  ): string;
...
export interface InviterLogic extends BaseContract {
  ...
  functions: {
    ...
    calcInvitersRewards(
      params: InputTypes.CalcInvitersRewardsInputStruct,
      overrides?: CallOverrides
    ): Promise<[OutputTypes.CalcInvitersRewardsOutputStructOutput]>;
  };
