...
export interface InvoiceLogicInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "calcBuyerFee" | "calcSellerFee"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "calcBuyerFee",
    values: [PromiseOrValue<BigNumberish>, DataTypes.FeeParamsStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "calcSellerFee",
    values: [PromiseOrValue<BigNumberish>, DataTypes.FeeParamsStruct]
  ): string;
...
export interface InvoiceLogic extends BaseContract {
  ...
  functions: {
    calcBuyerFee(
      ...
      buyerFees: DataTypes.FeeParamsStruct,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    calcSellerFee(
      price: PromiseOrValue<BigNumberish>,
      sellerFees: DataTypes.FeeParamsStruct,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
  };
