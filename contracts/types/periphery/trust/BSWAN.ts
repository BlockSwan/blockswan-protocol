...
export interface BSWANInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "buySlopeDen",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "buySlopeNum",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "buybackReserve",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "estimateSellValue",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "investmentReserveBasisPoints",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "revenueCommitmentBasisPoints",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface BSWAN extends BaseContract {
  ...
  functions: {
    ...
    estimateSellValue(
      _quantityToSell: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    sell(
      _to: PromiseOrValue<string>,
      _quantityToSell: PromiseOrValue<BigNumberish>,
      _minCurrencyReturned: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "UpdateConfig(address,uint256,uint256)"(
      ...
      _revenueCommitmentBasisPoints?: null,
      _minInvestment?: null
