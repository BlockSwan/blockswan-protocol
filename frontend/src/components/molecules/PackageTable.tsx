...
export default function PackageTable({
   ...
   const onCheckBoxClick = (
      ...
      if (!newPackages[packageIndex]?.includes)
         newPackages[packageIndex].includes =
            [] as BoooleanDeliverablesProps[]
      ...
      if (checked) {
         ...
         if (deliverableIndex > -1) {
            newPackages[packageIndex]?.includes?.splice(
               deliverableIndex,
               1
            )
         }
   ...
   if (!booleanDeliverables || !packages || !packages[0])
      return null
      ...
      >
         ...
         >
            ...
            <TableBody>
               ...
               <TableRow>
                  <StyledTableCell isBottom={false}>
                     Price in $
                  </StyledTableCell>
                  {['Basic', 'Standard', 'Premium']?.map(
                     (_, index: number) => (
            ...
            {isCreatePackage && (
               <Overhead>
                  <Typography variant="body2">
                     Offer packages to meet the needs of
                     more buyers
                  </Typography>
                  <Button
                     sx={{
