...
export const possibleLanguageLevelType = ['native-bilingual', 'fluent', 'conversational', ""] as const;

export type LanguageLevelType = string & typeof possibleLanguageLevelType[number];
