...
class Dispute__factory extends ethers_1.ContractFactory {
    ...
    static linkBytecode(linkLibraryAddresses) {
        ...
        linkedBytecode = linkedBytecode.replace(new RegExp("__\\$499c06b2b29ab2ab1aba66b7d414a45a21\\$__", "g"), linkLibraryAddresses["contracts/protocol/libraries/logics/DisputeLogic.sol:DisputeLogic"]
            .replace(/^0x/, "")
            .toLowerCase());
...
exports.Dispute__factory = Dispute__factory;
Dispute__factory.bytecode = _bytecode;
Dispute__factory.abi = _abi;
