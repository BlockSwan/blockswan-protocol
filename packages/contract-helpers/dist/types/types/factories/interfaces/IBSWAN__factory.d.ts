...
import type { IBSWAN, IBSWANInterface } from "../../interfaces/IBSWAN";
export declare class IBSWAN__factory {
    ...
    static createInterface(): IBSWANInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IBSWAN;
}
