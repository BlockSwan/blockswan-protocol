...
export interface IXPInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "approve" | "balanceOf" | "getXpAmount" | "mint" | "setXpAmount" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
...
export interface IXP extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IXPInterface;
    ...
    functions: {
        ...
        getXpAmount(xpKey: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
