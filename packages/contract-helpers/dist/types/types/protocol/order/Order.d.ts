...
export declare namespace InputTypes {
    ...
    type CreateOrderInputStructOutput = [
        BigNumber,
        BigNumber,
        BigNumber,
        BigNumber,
...
export interface OrderInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "ADDRESSES_PROVIDER" | "ADDRESS_PROVIDER" | "MAX_UINT" | "approve" | "autoRefund" | "confirmOrder" | "createOrder" | "dispute" | "fetchContract" | "getInvitersByAddress" | "getInvitersById" | "getOrderById" | "getOrderCount" | "getOrderList" | "getUserIdByAddress" | "hasProtocolRole" | "isCallerUser" | "isGigOwner" | "isStillBuyer" | "isStillSeller" | "kill" | "owner" | "payOrder" | "refundOrder" | "renounceOwnership" | "rule" | "setProvider" | "transferOwnership"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "autoRefund", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "confirmOrder", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "createOrder", values: [InputTypes.CreateOrderInputStruct]): string;
    encodeFunctionData(functionFragment: "dispute", values: [
    ...
    encodeFunctionData(functionFragment: "getInvitersByAddress", values: [PromiseOrValue<string>, PromiseOrValue<string>]): string;
    ...
    encodeFunctionData(functionFragment: "getOrderList", values?: undefined): string;
    encodeFunctionData(functionFragment: "getUserIdByAddress", values: [PromiseOrValue<string>, PromiseOrValue<string>]): string;
    ...
    encodeFunctionData(functionFragment: "payOrder", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "refundOrder", values: [
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>
    ]): string;
    ...
    decodeFunctionResult(functionFragment: "confirmOrder", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "getInvitersByAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "getOrderList", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getUserIdByAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "refundOrder", data: BytesLike): Result;
...
export interface Order extends BaseContract {
    ...
    functions: {
        ...
        autoRefund(orderId: PromiseOrValue<BigNumberish>, buyerId: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        confirmOrder(orderId: PromiseOrValue<BigNumberish>, sellerId: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        createOrder(input: InputTypes.CreateOrderInputStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        dispute(orderId: PromiseOrValue<BigNumberish>, sellerId: PromiseOrValue<BigNumberish>, buyerId: PromiseOrValue<BigNumberish>, evidence: DataTypes.EvidenceStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        fetchContract(_name: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[string]>;
        getInvitersByAddress(account: PromiseOrValue<string>, UserContract: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string, string]>;
        ...
        getOrderList(overrides?: CallOverrides): Promise<[OutputTypes.OrderOutputStructOutput[]]>;
        getUserIdByAddress(caller: PromiseOrValue<string>, UserContract: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        payOrder(orderId: PromiseOrValue<BigNumberish>, buyerId: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        refundOrder(orderId: PromiseOrValue<BigNumberish>, sellerId: PromiseOrValue<BigNumberish>, buyerId: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        autoRefund(orderId: PromiseOrValue<BigNumberish>, buyerId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        confirmOrder(orderId: PromiseOrValue<BigNumberish>, sellerId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        createOrder(input: InputTypes.CreateOrderInputStruct, overrides?: CallOverrides): Promise<void>;
        dispute(orderId: PromiseOrValue<BigNumberish>, sellerId: PromiseOrValue<BigNumberish>, buyerId: PromiseOrValue<BigNumberish>, evidence: DataTypes.EvidenceStruct, overrides?: CallOverrides): Promise<void>;
        fetchContract(_name: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
        getInvitersByAddress(account: PromiseOrValue<string>, UserContract: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string, string]>;
        getInvitersById(userId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string, string]>;
        getOrderById(orderId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<OutputTypes.OrderOutputStructOutput>;
        ...
        owner(overrides?: CallOverrides): Promise<string>;
        payOrder(orderId: PromiseOrValue<BigNumberish>, buyerId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        refundOrder(orderId: PromiseOrValue<BigNumberish>, sellerId: PromiseOrValue<BigNumberish>, buyerId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        getInvitersByAddress(account: PromiseOrValue<string>, UserContract: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getInvitersByAddress(account: PromiseOrValue<string>, UserContract: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getUserIdByAddress(caller: PromiseOrValue<string>, UserContract: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
