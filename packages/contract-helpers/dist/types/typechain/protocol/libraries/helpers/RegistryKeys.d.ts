...
export interface RegistryKeysInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "ACL_ADMIN" | "ACL_MANAGER" | "DAT" | "DATA_PROVIDER" | "DISPUTE" | "GIG" | "JURY" | "ORDER" | "PROTOCOL_CONFIGURATOR" | "TREE_KEY" | "USER" | "XP"): FunctionFragment;
    encodeFunctionData(functionFragment: "ACL_ADMIN", values?: undefined): string;
    encodeFunctionData(functionFragment: "ACL_MANAGER", values?: undefined): string;
    encodeFunctionData(functionFragment: "DAT", values?: undefined): string;
    encodeFunctionData(functionFragment: "DATA_PROVIDER", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "PROTOCOL_CONFIGURATOR", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "ACL_MANAGER", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "DAT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "DATA_PROVIDER", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "PROTOCOL_CONFIGURATOR", data: BytesLike): Result;
...
export interface RegistryKeys extends BaseContract {
    ...
    populateTransaction: {
        ...
        PROTOCOL_CONFIGURATOR(overrides?: CallOverrides): Promise<PopulatedTransaction>;
