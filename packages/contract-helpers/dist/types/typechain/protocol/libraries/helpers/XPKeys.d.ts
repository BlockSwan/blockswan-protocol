...
export interface XPKeysInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "BECOME_BUYER" | "BECOME_SELLER" | "CREATE_GIG" | "CREATE_ORDER" | "PAY_ORDER"): FunctionFragment;
    encodeFunctionData(functionFragment: "BECOME_BUYER", values?: undefined): string;
    encodeFunctionData(functionFragment: "BECOME_SELLER", values?: undefined): string;
    encodeFunctionData(functionFragment: "CREATE_GIG", values?: undefined): string;
    encodeFunctionData(functionFragment: "CREATE_ORDER", values?: undefined): string;
    encodeFunctionData(functionFragment: "PAY_ORDER", values?: undefined): string;
    decodeFunctionResult(functionFragment: "BECOME_BUYER", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "BECOME_SELLER", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "CREATE_GIG", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "CREATE_ORDER", data: BytesLike): Result;
