...
import type { IGig, IGigInterface } from "../IGig";
...
export class IGig__factory {
  static readonly abi = _abi;
  static createInterface(): IGigInterface {
    return new utils.Interface(_abi) as IGigInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IGig {
    return new Contract(address, _abi, signerOrProvider) as IGig;
  }
}
