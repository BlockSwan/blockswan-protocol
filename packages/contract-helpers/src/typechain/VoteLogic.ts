...
export interface VoteLogicInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "commit" | "isBetweenRange" | "isVoteCorrect"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "isBetweenRange",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "isVoteCorrect",
    values: [DataTypes.VoteStruct, PromiseOrValue<BigNumberish>]
  ): string;
...
export interface VoteLogic extends BaseContract {
  ...
  functions: {
    commit(
      ...
      [DataTypes.VoteStructOutput] & { newVote: DataTypes.VoteStructOutput }
    >;

    isBetweenRange(
      vote: DataTypes.VoteStruct,
  ...
  commit(
    ...
    salt: PromiseOrValue<string>,
    overrides?: CallOverrides
  ): Promise<DataTypes.VoteStructOutput>;
