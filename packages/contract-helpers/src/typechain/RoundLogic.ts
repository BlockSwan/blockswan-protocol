...
export interface RoundLogicInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "calcEarnedFromDisputeFees"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "calcEarnedFromDisputeFees",
    values: [
...
export interface RoundLogic extends BaseContract {
  ...
  functions: {
    calcEarnedFromDisputeFees(
      jurorWeight: PromiseOrValue<BigNumberish>,
      weightOfCorrectVotes: PromiseOrValue<BigNumberish>,
      disputePrice: PromiseOrValue<BigNumberish>,
