...
export interface DisputeLogicInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "calcDisputeDelaysFromBlock"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "calcDisputeDelaysFromBlock",
    values: [
...
export interface DisputeLogic extends BaseContract {
  ...
  functions: {
    calcDisputeDelaysFromBlock(
      evidenceUntil: PromiseOrValue<BigNumberish>,
      commitUntil: PromiseOrValue<BigNumberish>,
      voteUntil: PromiseOrValue<BigNumberish>,
      appealUntil: PromiseOrValue<BigNumberish>,
